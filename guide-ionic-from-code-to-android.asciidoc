...
image:images/ionic-to-android/create-new-device.png["",width="400" link="images/ionic-to-android/create-new-device.png"]
image:images/ionic-to-android/new-phone-nexus.png["",width="400" link="images/ionic-to-android/new-phone-nexus.png"]
...
4. Verify configuration (default configuration should be enough). Click "Next".

image:images/ionic-to-android/download-so.png["",width="400" link="images/ionic-to-android/download-so.png"]
image:images/ionic-to-android/config-device.png["",width="400" link="images/ionic-to-android/config-device.png"]

[start=5]
5. Check that the new device is created correctly.

image::images/ionic-to-android/new-phone-created.png["",width="400" link="images/ionic-to-android/new-phone-created.png"]
